...
Not all items generated have total funcionality yet. As a GM, check that the details of the item are correct.
Money containers only work corretly when giving them to players characters as most NPCs and creatures lack deault coin items.

To install it copy the followinf url in the Foundry Module instalation dialog:
https://raw.githubusercontent.com/fmunoz-geo/wfrp4e-random-treasure/main/module.json
